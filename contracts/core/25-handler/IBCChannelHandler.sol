...
abstract contract IBCChannelHandler is ModuleManager {
    ...
    function channelOpenInit(
    ...
    ) external returns (Channel.Attributes memory attr) {
        ...
        IBCUtil.check_delegatecall(success, res, "channelOpenInit");
        ...
        emit OpenInitChannel(
            attr.portId,
            attr.channelId,
            attr.connectionId,
            attr.counterpartyPortId,
            attr.counterpartyChannelId
        );
        return attr;
    }
    ...
    function channelOpenTry(
    ...
    ) external returns (Channel.Attributes memory attr) {
        {
            ...
            IBCUtil.check_delegatecall(success, res, "channelOpenTry");
            attr = abi.decode(res, (Channel.Attributes));
        }
        string memory channelId = attr.channelId;
        IIBCModule module = lookupModuleByPort(msg_.portId);
    ...
    function channelOpenAck(
        ...
        IBCUtil.check_delegatecall(success, res, "channelOpenAck");
        attr = abi.decode(res, (Channel.Attributes));
    ...
    function channelOpenConfirm(
        ...
        IBCUtil.check_delegatecall(success, res, "channelOpenConfirm");
        attr = abi.decode(res, (Channel.Attributes));
        lookupModuleByPort(msg_.portId).onChanOpenConfirm(
            msg_.portId,
            msg_.channelId
        );
        emit OpenConfirmChannel(
            attr.portId,
            attr.channelId,
            attr.connectionId,
            attr.counterpartyPortId,
    ...
    function channelCloseInit(
        ...
        IBCUtil.check_delegatecall(success, res, "channelCloseInit");
        attr = abi.decode(res, (Channel.Attributes));
        lookupModuleByPort(msg_.portId).onChanCloseInit(
            msg_.portId,
            msg_.channelId
        );
        emit CloseInitChannel(
            attr.portId,
            attr.channelId,
            attr.connectionId,
            attr.counterpartyPortId,
    ...
    function channelCloseConfirm(
        ...
        IBCUtil.check_delegatecall(success, res, "channelCloseConfirm");
        attr = abi.decode(res, (Channel.Attributes));
        lookupModuleByPort(msg_.portId).onChanCloseConfirm(
            msg_.portId,
            msg_.channelId
        );
        emit CloseConfirmChannel(
            attr.portId,
            attr.channelId,
            attr.connectionId,
            attr.counterpartyPortId,
