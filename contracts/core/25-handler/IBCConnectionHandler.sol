...
abstract contract IBCConnectionHandler {
    ...
    function connectionOpenInit(
    ...
    ) external returns (ConnectionEnd.Attributes memory attr) {
        ...
        IBCUtil.check_delegatecall(success, res, "connectionOpenInit");
        attr = abi.decode(res, (ConnectionEnd.Attributes));
        emit OpenInitConnection(
            attr.connectionId,
            attr.clientId,
            attr.counterpartyConnectionId,
            attr.counterpartyClientId
        );
        return attr;
    }
    ...
    function connectionOpenTry(
        ...
        IBCUtil.check_delegatecall(success, res, "connectionOpenTry");
        attr = abi.decode(res, (ConnectionEnd.Attributes));
        emit OpenTryConnection(
            attr.connectionId,
            attr.clientId,
            attr.counterpartyConnectionId,
            attr.counterpartyClientId
    ...
    function connectionOpenAck(
        ...
        IBCUtil.check_delegatecall(success, res, "connectionOpenAck");
        attr = abi.decode(res, (ConnectionEnd.Attributes));
        emit OpenAckConnection(
            attr.connectionId,
            attr.clientId,
            attr.counterpartyConnectionId,
            attr.counterpartyClientId
    ...
    function connectionOpenConfirm(
        ...
        IBCUtil.check_delegatecall(success, res, "connectionOpenConfirm");
        attr = abi.decode(res, (ConnectionEnd.Attributes));
        emit OpenConfirmConnection(
            attr.connectionId,
            attr.clientId,
            attr.counterpartyConnectionId,
            attr.counterpartyClientId
