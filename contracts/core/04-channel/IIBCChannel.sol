...
interface IIBCChannelHandshake {
     ...
     */
    function channelOpenInit(IBCMsgs.MsgChannelOpenInit calldata msg_) external returns (Channel.Attributes memory);
     ...
     */
    function channelOpenTry(IBCMsgs.MsgChannelOpenTry calldata msg_) external returns (Channel.Attributes memory);
     ...
     */
    function channelOpenAck(IBCMsgs.MsgChannelOpenAck calldata msg_) external returns (Channel.Attributes memory);
     ...
     */
    function channelOpenConfirm(IBCMsgs.MsgChannelOpenConfirm calldata msg_) external returns (Channel.Attributes memory);
     ...
     */
    function channelCloseInit(IBCMsgs.MsgChannelCloseInit calldata msg_) external returns (Channel.Attributes memory);

    /**
     * @dev channelCloseConfirm is called by the counterparty module to close their end of the
     * channel, since the other end has been closed.
     */
    function channelCloseConfirm(IBCMsgs.MsgChannelCloseConfirm calldata msg_) external returns (Channel.Attributes memory);
}
